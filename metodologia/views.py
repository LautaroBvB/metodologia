...
def register(request):
    ...
    if request.method == "POST":
        ...
        try:
            res = create_confirmed_user(email, password)
...
def admin_dashboard(request):
    try:
        ...
        return render(request, "admin_dashboard.html", {"products": [], "error": str(e)})
...
admin_product_create_fixed = admin_product_create
admin_product_edit_fixed = admin_product_edit
